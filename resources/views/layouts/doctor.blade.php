...
<div class="wrapper">
    <div class="sidebar" data-background-color="brown" data-active-color="danger">
	    	...
	    	<div class="sidebar-wrapper">
				<div class="user">
	                <div class="photo">
	                    <img src="{{ asset('images/' . Session::get('doctor.image')) }}" />
	                </div>
	                <div class="info">
						<a data-toggle="collapse" href="#menu" class="collapsed">
	                        <span>
								{{ Session::get('doctor.full_name') }}
                                <b class="caret"></b>
							</span>
	                    </a>
	        ...
	        <ul class="nav">
					...
					<li>
	                    <a href="{{ route('info-doctor.index') }}">
	                        <i class="ti-info-alt"></i>
	                        <p>Thông tin bác sĩ</p>
	                    </a>
	                </li>
					<li>
	                    <a href="{{ route('info-rest.index') }}">
	                        <i class="ti-calendar"></i>
	                        <p>Lịch nghỉ bác sĩ</p>
	                    </a>
	                </li>
					<li>
	                    <a href="{{ route('info-appointment.index') }}">
	                        <i class="ti-calendar"></i>
