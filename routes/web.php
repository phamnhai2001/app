...
Route::middleware([CheckLoginDoctor::class])->group(function () {
    ...
    Route::resource('info-doctor', InformationDoctorController::class);
...
Route::get('/information-doctor/{id_doctor}', [InfoDoctorController::class, 'index'])->name("information-doctor");
